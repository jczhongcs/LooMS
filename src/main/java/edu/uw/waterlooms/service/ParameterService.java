...
//  private static double PPM = 0.000006;
  private static double PPM = 0.00001;

  private static double MZ_TOLERANCE_PPM =  0.000006; // formerly 0.00001;
  ...
  private static int WINDOW_HI = 6;
  ...
  public static void setWindowSize(int windowSize) { WINDOW_SIZE = windowSize; }

  public static int getWindowHi() { return WINDOW_HI; }

  public static void setWindowHi(int windowHi) { WINDOW_HI = windowHi; }
